...
#include "GraphicLib/GuiObjects/WidgetFactory.hpp"
        ...
        switch (type) {
            case TEXT_INPUT_FIELD:{
                ...
                auto textInputField = std::make_shared<TextInputField>
                    (std::dynamic_pointer_cast<Objects::Primitives::Rectangle>(textInputFieldStyle->figure),
            ...
            case NUM_INPUT_FIELD: {
                ...
                auto numInputField = std::make_shared<NumericInputField>
                    (std::dynamic_pointer_cast<Objects::Primitives::Rectangle>(inputFieldStyle->figure),
            ...
            case SCROLL_BOX: {
                auto scrollBoxStyle =   std::dynamic_pointer_cast<Styles::ScrollBoxStyle>(style);
                auto scrollBox = std::make_shared<VerticalScrollBox>();

                scrollBox->setBackgroundColor(scrollBoxStyle->backgroundColor);
                scrollBox->setSpeed(scrollBoxStyle->speed);
